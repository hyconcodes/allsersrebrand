    ...
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
            ...
            <flux:tooltip :content="__('Notifications')" position="bottom">
                <flux:navbar.item class="!h-10 [&>div>svg]:size-5" icon="bell" href="#" :label="__('Notifications')" />
            </flux:tooltip>
            <flux:tooltip :content="__('Location')" position="bottom">
                <flux:navbar.item class="!h-10 [&>div>svg]:size-5" icon="map-pin" href="#" :label="__('Location')" />
            </flux:tooltip>
        </flux:navbar>
